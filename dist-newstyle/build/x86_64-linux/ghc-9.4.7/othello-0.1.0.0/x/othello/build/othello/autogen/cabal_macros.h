...
/* package othello-0.1.0.0 */
#ifndef VERSION_othello
#define VERSION_othello "0.1.0.0"
#endif /* VERSION_othello */
#ifndef MIN_VERSION_othello
#define MIN_VERSION_othello(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_othello */
...
#define CURRENT_COMPONENT_ID "othello-0.1.0.0-inplace-othello"
